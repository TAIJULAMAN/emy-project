/* EMY template wrapper for 27-template-customer-home.cjs (parts in 27-customer-home-template-parts.cjs) */
const customerHomeEarlyFeedCreateScript = String.raw`
    <script data-emy-home-lazy-loader data-emy-customer-home-create-bootstrap>
      (function () {
...
function emyCustomerHomePageTemplate() {
  return (customer_home_part_1
    + bottomNavTooltipCss
    + customer_home_part_2
    + askBagDoodleCss
    + customerTopbarCss
    + itemDetailModalCss
    + feedCreateFlowCss
    + feedCreateFlowCss
    + customer_home_part_3
    + customerTopbarCss
    + itemDetailModalCss
    + customer_home_part_4
    + customerTopbarMarkup()
    + customer_home_part_5
    + itemDetailModalMarkup
    + feedCreateFlowMarkup
    + customer_home_part_6
    + emyCustomerRouterScript
    + customer_home_part_6_script_open
    + emyFeedsAppInstallCode
    ...
    + customer_home_part_7
    + customer_home_part_8
    + askBagDoodleScript
    + emyCustomerHomeBootScript
    + customer_home_part_9
    + customer_home_part_10);
}
