      ...
      (() => {
        ...
        (function setupEmyMediaStoreRuntime() {
          ...
          function mediaNodeNearViewport(node) {
            ...
            try {
              ...
              const margin = Math.max(760, Math.round(viewportHeight * 1.15));
          ...
          function mediaHydrationObserverFor() {
            ...
            }, { rootMargin: "900px 0px 1200px", threshold: 0.01 });
        ...
        function chatNotificationTarget(item) {
          if (!item) return "emy-customer-home.html?tab=feeds#feeds";
          const raw = item.raw && typeof item.raw === "object" ? item.raw : item;
          ...
          return "emy-customer-home.html?tab=feeds#feeds";
        }
        ...
        function renderReference(ref, business) {
          ...
          const href = clean(ref.href) || (kind === "clip" ? "emy-customer-home.html?tab=reels#reels" : kind === "post" ? "emy-customer-home.html?tab=feeds#feeds" : "emy-customer-search.html#products");
        ...
        function openReferenceDetailFromChat(link) {
          ...
          const href = link.getAttribute("href") || (String(data.detailKind || "").toLowerCase().includes("clip") ? "emy-customer-home.html?tab=reels#reels" : String(data.detailKind || "").toLowerCase().includes("post") ? "emy-customer-home.html?tab=feeds#feeds" : "emy-customer-search.html#products");
        ...
        document.querySelectorAll("[data-nav]").forEach((button) => {
          button.addEventListener("click", () => {
            ...
            if (nav === "nearby") window.location.href = "emy-customer-home.html?tab=nearby#nearby";
            if (nav === "feeds") window.location.href = "emy-customer-home.html?tab=feeds#feeds";
            if (nav === "reels") window.location.href = "emy-customer-home.html?tab=reels#reels";
        ...
        (function setupItemDetailModal() {
          ...
          function detailSavedFeedRecord(card, details) {
            ...
            let href = "emy-customer-home.html?tab=feeds#feeds";
            if (kindText.includes("clip")) href = "emy-customer-home.html?tab=reels#reels";
          ...
          function detailRepostRecordFrom(card, details, thought) {
            ...
            return {
              ...
              original: {
                ...
                href: "emy-customer-home.html?tab=feeds#feeds"
              }
            };
          }
          ...
          function chatReferenceHref(ref) {
            ...
            if (kind === "clip") return "emy-customer-home.html?tab=reels#reels";
            if (kind === "post") return "emy-customer-home.html?tab=feeds#feeds";
          ...
          function chatContextFromDetails(details) {
            ...
            return {
              ...
              href: kind === "clip" ? "emy-customer-home.html?tab=reels#reels" : kind === "post" ? "emy-customer-home.html?tab=feeds#feeds" : "emy-customer-search.html#products"
            };
          }
